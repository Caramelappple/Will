namespace _Scripts.LSO.UI.Input
{
    ...
    public enum LSO_ClickBlockCondition
    {
        ...
        /// 튜토리얼이 도는 중.
        ///
        /// 대본이 "이걸 눌러보세요" 하기 전까지는 아무것도 눌리면 안 된다.
        /// 걸음마다 무엇을 허용할지는 LSO_TutorialLock 이 정하지만, 그쪽이 못 보는
        /// 물건(촛대·상자·그 밖의 클릭 대상)은 여기서 한꺼번에 막는다.
        ///
        /// All 보다 뒤 번호인 것은 값이 에셋에 int 로 저장되기 때문이다.
        /// All 자체는 목록이 아니라 "나머지 전부"를 훑는 표시라 번호 순서와 무관하다.
        /// </summary>
        TutorialPlaying = 7,
